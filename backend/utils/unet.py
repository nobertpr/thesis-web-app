...
class UNet(pl.LightningModule):
    def __init__(self, n_classes, lr=1e-4, encoder_name="resnet50", encoder_weights="imagenet", id2label=None):
        ...
        self.model = smp.Unet(encoder_name=encoder_name,encoder_weights=encoder_weights,classes=n_classes)
        self.lr = lr
...
#         self.log("train_tm_iou_class",tm_iou_class,prog_bar=True, on_step=False, on_epoch=True)
